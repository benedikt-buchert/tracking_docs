...
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.1.1/add-to-cart-event.json
---

import SchemaViewer from "@theme/SchemaViewer";
import SchemaJsonViewer from "@theme/SchemaJsonViewer";
import TopPartial from "@site/versioned_docs/version-1.1.1/partials/_add-to-cart-event.mdx";
import BottomPartial from "@site/versioned_docs/version-1.1.1/partials/_add-to-cart-event_bottom.mdx";
...
<SchemaViewer
  schema={{
    ...
    $id: "https://tracking-docs-demo.buchert.digital/schemas/1.1.1/add-to-cart-event.json",
    title: "Add to Cart Event",
    description:
      "An add_to_cart event fires when a user adds one or more items to their shopping cart. Based on Google Analytics 4 ecommerce event specifications.",
    type: "object",
