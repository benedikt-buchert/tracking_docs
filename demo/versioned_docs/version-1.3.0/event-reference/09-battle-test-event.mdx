...
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.3.0/web/battle-test-event.json
---
...
<SchemaViewer
  schema={{
    ...
    if: {
      properties: {
        payment: {
          properties: {
            currency: { const: "USD", description: "ISO 4217 currency code." },
          },
        },
      },
    },
  ...
  sourcePath={"web/battle-test-event.json"}
  schemaSources={{
