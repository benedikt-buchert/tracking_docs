...
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.3.0/web/add-to-cart-event.json
---

import SchemaViewer from "@theme/SchemaViewer";
import SchemaJsonViewer from "@theme/SchemaJsonViewer";
import TopPartial from "@site/versioned_docs/version-1.3.0/partials/event-reference/_add-to-cart-event.mdx";
import BottomPartial from "@site/versioned_docs/version-1.3.0/partials/event-reference/_add-to-cart-event_bottom.mdx";
...
<SchemaViewer
  ...
  sourcePath={"web/add-to-cart-event.json"}
  schemaSources={{
