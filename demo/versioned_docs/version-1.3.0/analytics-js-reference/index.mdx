...
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.3.0/analytics-js-reference.json
---
...
<SchemaJsonViewer
  schema={{
    ...
    $id: "https://tracking-docs-demo.buchert.digital/schemas/1.3.0/analytics-js-reference.json",
    title: "Analytics.js Reference",
    description:
      "Analytics.js-compatible event examples for Segment, RudderStack, and Hightouch.",
    type: "object",
    oneOf: [
      { $ref: "./analytics-js/track-purchase.json" },
      { $ref: "./analytics-js/identify-user.json" },
      { $ref: "./analytics-js/group-company.json" },
      { $ref: "./analytics-js/page-view.json" },
    ],
  }}
  sourcePath={"analytics-js-reference.json"}
  schemaSources={{
    "analytics-js-reference.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/1.3.0/analytics-js-reference.json",
      title: "Analytics.js Reference",
      description:
    ...
    "analytics-js/track-purchase.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      ...
      properties: {
        ...
        order_id: {
          ...
          examples: ["ORD-12345", "TXN-20231205-001"],
        },
        products: {
          type: "array",
    ...
    "analytics-js/identify-user.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      ...
      properties: {
        ...
        userId: {
          ...
          examples: ["usr_12345", "user@example.com"],
        },
        email: {
          type: "string",
          description: "The email address of the user.",
          examples: ["jane@example.com", "john.doe@company.com"],
        },
        name: {
          type: "string",
        ...
        created_at: {
          ...
          examples: ["2024-01-15T10:30:00Z", "2023-06-01T00:00:00Z"],
        },
      },
      required: ["$schema"],
    },
    ...
    "analytics-js/page-view.json": {
      ...
      properties: {
        ...
        name: {
          ...
          examples: ["Home", "Product Detail", "Checkout"],
        },
        category: {
          type: "string",
          description: "The category of the page.",
          examples: ["Marketing", "Ecommerce", "Account"],
        },
        url: {
          type: "string",
        ...
        referrer: {
          ...
          examples: ["https://google.com", "https://example.com/"],
        },
        search: {
          type: "string",
          description: "The text the user searched for.",
          examples: ["shoes", "newsletter"],
        },
      },
      required: ["$schema"],
    },
