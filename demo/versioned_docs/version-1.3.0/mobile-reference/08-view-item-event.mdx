...
sidebar_label: View Item
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.3.0/mobile/view-item-event.json
---
...
Triggered when a user views an item detail.
...
<SchemaViewer
  ...
  sourcePath={"mobile/view-item-event.json"}
  schemaSources={{
