...
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.3.0/mobile/purchase-event.json
---
...
<SchemaViewer
  ...
  sourcePath={"mobile/purchase-event.json"}
  schemaSources={{
