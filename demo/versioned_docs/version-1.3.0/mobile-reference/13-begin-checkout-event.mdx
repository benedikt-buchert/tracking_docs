...
sidebar_label: Begin Checkout
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.3.0/mobile/begin-checkout-event.json
---
...
<SchemaViewer
  ...
  sourcePath={"mobile/begin-checkout-event.json"}
  schemaSources={{
