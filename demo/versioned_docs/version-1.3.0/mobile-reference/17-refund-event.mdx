...
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.3.0/mobile/refund-event.json
---
...
<SchemaViewer
  ...
  sourcePath={"mobile/refund-event.json"}
  schemaSources={{
