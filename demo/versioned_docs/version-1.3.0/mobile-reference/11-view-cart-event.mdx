...
sidebar_label: View Cart
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.3.0/mobile/view-cart-event.json
---
...
Triggered when a user views the cart.
...
<SchemaViewer
  ...
  sourcePath={"mobile/view-cart-event.json"}
  schemaSources={{
