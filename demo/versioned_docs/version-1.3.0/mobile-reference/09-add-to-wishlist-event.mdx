...
sidebar_label: Add To Wishlist
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.3.0/mobile/add-to-wishlist-event.json
---
...
Triggered when an item is added to wishlist.
...
<SchemaViewer
  ...
  sourcePath={"mobile/add-to-wishlist-event.json"}
  schemaSources={{
