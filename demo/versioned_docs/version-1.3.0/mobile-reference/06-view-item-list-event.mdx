...
sidebar_label: View Item List
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.3.0/mobile/view-item-list-event.json
---
...
Triggered when a user views an item list.
...
<SchemaViewer
  ...
  sourcePath={"mobile/view-item-list-event.json"}
  schemaSources={{
