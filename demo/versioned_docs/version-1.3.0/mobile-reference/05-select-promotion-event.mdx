...
sidebar_label: Select Promotion
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.3.0/mobile/select-promotion-event.json
---
...
<SchemaViewer
  ...
  sourcePath={"mobile/select-promotion-event.json"}
  schemaSources={{
