...
sidebar_label: Add To Cart
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.3.0/mobile/add-to-cart-event.json
---
...
<SchemaViewer
  ...
  sourcePath={"mobile/add-to-cart-event.json"}
  schemaSources={{
