...
sidebar_label: View Promotion
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.3.0/mobile/view-promotion-event.json
---
...
<SchemaViewer
  ...
  sourcePath={"mobile/view-promotion-event.json"}
  schemaSources={{
