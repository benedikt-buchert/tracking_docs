...
description: "Triggered when a user submits payment information in checkout."
sidebar_label: Add Payment Info
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.3.0/mobile/add-payment-info-event.json
---
...
<SchemaViewer
  ...
  sourcePath={"mobile/add-payment-info-event.json"}
  schemaSources={{
