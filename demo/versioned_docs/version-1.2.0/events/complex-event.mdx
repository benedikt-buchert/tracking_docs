...
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.2.0/complex-event.json
---
...
<SchemaViewer
  schema={{
    ...
    $id: 'https://tracking-docs-demo.buchert.digital/schemas/1.2.0/complex-event.json',
    title: 'Complex Event with Validation Constraints',
    description:
      'A generic event demonstrating various validation constraints and recursive documentation capabilities.',
    type: 'object',
    ...
    properties: {
          ...
          addresses: {
            ...
            items: {
              ...
              properties: {
                ...
                zip: { type: 'string', examples: ['10001'] },
              },
            },
          },
        },
      ...
      object_constraints: {
        ...
        properties: {
          prop_a: { type: 'string', examples: ['some_value'] },
          prop_b: { type: 'string', examples: ['another_value'] },
        },
      },
      dependent_required_constraint: {
        ...
        properties: {
          credit_card: { type: 'number', examples: [1234567890123456] },
          billing_address: {
            type: 'string',
