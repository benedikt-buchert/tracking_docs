...
<SchemaViewer
  schema={{
    ...
    $id: "https://tracking-docs-demo.buchert.digital/schemas/1.2.0/events/nested-conditional-event.json",
    title: "Nested Conditional Event",
    description:
      "An event demonstrating if/then/else conditional properties nested inside a property. The shipping details depend on the selected method.",
    type: "object",
    ...
    properties: {
      $schema: {
        ...
        const:
          "https://tracking-docs-demo.buchert.digital/schemas/1.2.0/events/nested-conditional-event.json",
      },
      event: {
        type: "string",
        const: "order_placed",
