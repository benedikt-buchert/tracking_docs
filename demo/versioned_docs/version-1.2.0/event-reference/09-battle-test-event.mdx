...
sidebar_label: Battle Test Event
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/1.2.0/events/battle-test-event.json
---
...
<SchemaViewer
  schema={{
    ...
    $id: "https://tracking-docs-demo.buchert.digital/schemas/1.2.0/events/battle-test-event.json",
    title: "Battle Test Event",
    description:
      "A stress-test event exercising every nesting combination: oneOf/anyOf inside if/then/else, if/then/else inside oneOf/anyOf branches, nested conditionals inside conditionals, array items with all combos, and deeply nested objects.",
    type: "object",
    ...
    if: {
      properties: { payment: { properties: { currency: { const: "USD" } } } },
    },
    then: {
      description: "USD transactions require tax information.",
      properties: {
        tax: {
          type: "object",
    ...
    properties: {
      $schema: {
        ...
        const:
          "https://tracking-docs-demo.buchert.digital/schemas/1.2.0/events/battle-test-event.json",
      },
      event: {
        type: "string",
        ...
        anyOf: [
          {
            ...
            properties: {
              fulfillment_method: { type: "string", const: "home_delivery" },
              address: {
                type: "object",
