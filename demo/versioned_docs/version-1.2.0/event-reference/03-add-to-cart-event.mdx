...
import TopPartial from "@site/versioned_docs/version-1.2.0/partials/_add-to-cart-event.mdx";
import BottomPartial from "@site/versioned_docs/version-1.2.0/partials/_add-to-cart-event_bottom.mdx";
...
<SchemaViewer
  ...
  sourcePath={"events/add-to-cart-event.json"}
  schemaSources={{
