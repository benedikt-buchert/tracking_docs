...
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/next/mobile/checkout-options-event.json
---
...
<SchemaViewer
  schema={{
    ...
    if: { properties: { platform: { const: "ios" } }, required: ["platform"] },
  ...
  sourcePath={"mobile/checkout-options-event.json"}
  schemaSources={{
