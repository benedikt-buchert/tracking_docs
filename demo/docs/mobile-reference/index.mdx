...
<SchemaJsonViewer
  schema={{
    ...
    $id: "https://tracking-docs-demo.buchert.digital/schemas/next/mobile-reference.json",
    title: "Mobile Reference",
    description:
      "Dedicated Android and iOS Firebase snippets and schema examples.",
    type: "object",
    oneOf: [
      { $ref: "./mobile/screen-view-event.json" },
      { $ref: "./mobile/login-with-user-properties-event.json" },
      { $ref: "./mobile/checkout-options-event.json" },
      { $ref: "./mobile/view-promotion-event.json" },
      { $ref: "./mobile/select-promotion-event.json" },
      { $ref: "./mobile/view-item-list-event.json" },
      { $ref: "./mobile/select-item-event.json" },
      { $ref: "./mobile/view-item-event.json" },
      { $ref: "./mobile/add-to-wishlist-event.json" },
      { $ref: "./mobile/add-to-cart-event.json" },
      { $ref: "./mobile/view-cart-event.json" },
      { $ref: "./mobile/remove-from-cart-event.json" },
      { $ref: "./mobile/begin-checkout-event.json" },
      { $ref: "./mobile/add-shipping-info-event.json" },
      { $ref: "./mobile/add-payment-info-event.json" },
      { $ref: "./mobile/purchase-event.json" },
      { $ref: "./mobile/refund-event.json" },
      { $ref: "./mobile/in-app-purchase-event.json" },
      { $ref: "./mobile/custom-event.json" },
    ],
  }}
  sourcePath={"mobile-reference.json"}
  schemaSources={{
    "mobile-reference.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile-reference.json",
      title: "Mobile Reference",
      description:
        "Dedicated Android and iOS Firebase snippets and schema examples.",
      type: "object",
    ...
    "mobile/screen-view-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/screen-view-event.json",
      title: "Screen View",
      description:
    ...
    "mobile/login-with-user-properties-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/login-with-user-properties-event.json",
      ...
      properties: {
        ...
        user_properties: {
          type: "object",
          description:
            "Firebase user properties to set before logging the event.",
          properties: {
            sign_up_method: {
              type: "string",
          ...
          patternProperties: {
            "^custom_": {
              ...
              examples: ["vip_member", null],
            },
          },
          required: ["sign_up_method"],
        },
      },
      required: ["$schema", "event", "method", "user_properties"],
    },
    "mobile/checkout-options-event.json": {
      ...
      allOf: [
        ...
        },
        {
          ...
          then: { required: ["att_status"] },
          else: { required: ["ad_personalization_enabled"] },
        },
        {
          if: {
            properties: { identity_type: { const: "logged_in" } },
            required: ["identity_type"],
          },
          then: { required: ["identity_user_id"] },
          else: { required: ["identity_session_id"] },
        },
        {
          if: {
            properties: { contact_channel: { const: "email" } },
            required: ["contact_channel"],
          },
          then: { required: ["contact_email"] },
          else: { required: ["contact_push_token"] },
        },
      ],
      properties: {
        $schema: {
    ...
    "mobile/view-promotion-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/view-promotion-event.json",
      title: "View Promotion",
      description: "Triggered when a user views a promotion.",
      "x-tracking-targets": [
        "android-firebase-kotlin-sdk",
        "android-firebase-java-sdk",
        "ios-firebase-swift-sdk",
      ...
      properties: {
        ...
        event: {
          ...
          description: "The event name view_promotion.",
        },
        promotion_id: {
          type: "string",
    ...
    "components/items.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/components/items.json",
    ...
    "components/products.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/components/products.json",
      title: "A Product",
      description:
    ...
    "mobile/select-promotion-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/select-promotion-event.json",
    ...
    "mobile/view-item-list-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/view-item-list-event.json",
      title: "View Item List",
      description: "Triggered when a user views an item list.",
      "x-tracking-targets": [
        "android-firebase-kotlin-sdk",
        "android-firebase-java-sdk",
        "ios-firebase-swift-sdk",
      ...
      properties: {
        ...
        event: {
          ...
          description: "The event name view_item_list.",
        },
        item_list_id: {
          type: "string",
          description: "ID of the item list.",
          examples: ["related_products"],
        },
        item_list_name: {
          type: "string",
    ...
    "mobile/select-item-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/select-item-event.json",
      title: "Select Item",
      description: "Triggered when a user selects an item from a list.",
      "x-tracking-targets": [
        "android-firebase-kotlin-sdk",
        "android-firebase-java-sdk",
        "ios-firebase-swift-sdk",
      ...
      properties: {
        ...
        event: {
          type: "string",
          const: "select_item",
          description: "The event name select_item.",
        },
        item_list_id: {
          type: "string",
          description: "ID of the item list.",
    ...
    "mobile/view-item-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/view-item-event.json",
      title: "View Item",
      description: "Triggered when a user views an item detail.",
      "x-tracking-targets": [
        "android-firebase-kotlin-sdk",
        "android-firebase-java-sdk",
        "ios-firebase-swift-sdk",
      ...
      properties: {
        ...
        event: {
          type: "string",
          const: "view_item",
          description: "The event name view_item.",
        },
        currency: {
          type: "string",
    ...
    "mobile/add-to-wishlist-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/add-to-wishlist-event.json",
      title: "Add To Wishlist",
      description: "Triggered when an item is added to wishlist.",
      "x-tracking-targets": [
        "android-firebase-kotlin-sdk",
        "android-firebase-java-sdk",
        "ios-firebase-swift-sdk",
      ...
      properties: {
        ...
        event: {
          ...
          description: "The event name add_to_wishlist.",
        },
        currency: {
          type: "string",
          description: "ISO 4217 currency code.",
    ...
    "mobile/add-to-cart-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/add-to-cart-event.json",
      title: "Add To Cart",
      ...
      properties: {
        ...
        event: {
          type: "string",
          const: "add_to_cart",
          description: "The event name add_to_cart.",
        },
        currency: {
          type: "string",
          description: "ISO 4217 currency code.",
      ...
      required: ["$schema", "event", "currency", "items"],
      allOf: [
        {
          $ref: "https://tracking-docs-demo.buchert.digital/constraints/schemas/firebase/v1/flat-event-params.json",
        },
    ...
    "mobile/view-cart-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/view-cart-event.json",
      title: "View Cart",
      description: "Triggered when a user views the cart.",
      "x-tracking-targets": [
        "android-firebase-kotlin-sdk",
        "android-firebase-java-sdk",
        "ios-firebase-swift-sdk",
      ...
      properties: {
        ...
        event: {
          type: "string",
          const: "view_cart",
          description: "The event name view_cart.",
        },
        currency: {
          type: "string",
          description: "ISO 4217 currency code.",
    ...
    "mobile/remove-from-cart-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/remove-from-cart-event.json",
      ...
      properties: {
        ...
        event: {
          ...
          description: "The event name remove_from_cart.",
        },
        currency: {
          type: "string",
          description: "ISO 4217 currency code.",
    ...
    "mobile/begin-checkout-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/begin-checkout-event.json",
      title: "Begin Checkout",
      description: "Triggered when a user begins checkout.",
      "x-tracking-targets": [
        "android-firebase-kotlin-sdk",
        "android-firebase-java-sdk",
        "ios-firebase-swift-sdk",
      ...
      properties: {
        ...
        event: {
          ...
          description: "The event name begin_checkout.",
        },
        currency: {
          type: "string",
          description: "ISO 4217 currency code.",
    ...
    "mobile/add-shipping-info-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/add-shipping-info-event.json",
    ...
    "mobile/add-payment-info-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/add-payment-info-event.json",
      title: "Add Payment Info",
      description:
        "Triggered when a user submits payment information in checkout.",
      "x-tracking-targets": [
        "android-firebase-kotlin-sdk",
        "android-firebase-java-sdk",
        "ios-firebase-swift-sdk",
      ...
      properties: {
        ...
        event: {
          ...
          description: "The event name add_payment_info.",
        },
        currency: {
          type: "string",
          description: "ISO 4217 currency code.",
    ...
    "mobile/purchase-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/purchase-event.json",
      title: "Purchase",
      ...
      properties: {
        ...
        event: {
          type: "string",
          const: "purchase",
          description: "The event name purchase.",
        },
        transaction_id: {
          type: "string",
        ...
        tax: {
          type: "number",
          description: "Tax amount for the event.",
          examples: [3.6],
        },
        shipping: {
          type: "number",
          description: "Shipping cost for the event.",
          examples: [5.99],
        },
        payment_type: {
          type: "string",
    ...
    "mobile/refund-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/refund-event.json",
      title: "Refund",
      ...
      properties: {
        ...
        event: {
          type: "string",
          const: "refund",
          description: "The event name refund.",
        },
        transaction_id: {
          type: "string",
          description: "Unique transaction identifier.",
      ...
      required: ["$schema", "event", "transaction_id"],
      allOf: [
        {
          $ref: "https://tracking-docs-demo.buchert.digital/constraints/schemas/firebase/v1/flat-event-params.json",
        },
    ...
    "mobile/in-app-purchase-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/in-app-purchase-event.json",
    ...
    "mobile/custom-event.json": {
      $schema: "https://json-schema.org/draft/2020-12/schema",
      $id: "https://tracking-docs-demo.buchert.digital/schemas/mobile/custom-event.json",
      title: "Custom Event",
