...
sidebar_label: Add Shipping Info
custom_edit_url: https://github.com/benedikt-buchert/tracking_docs/edit/main/demo/static/schemas/next/mobile/add-shipping-info-event.json
---
...
<SchemaViewer
  ...
  sourcePath={"mobile/add-shipping-info-event.json"}
  schemaSources={{
