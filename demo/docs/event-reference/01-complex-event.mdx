...
<SchemaViewer
  schema={{
    ...
    $id: "https://tracking-docs-demo.buchert.digital/schemas/events/complex-event.json",
    title: "Complex Event with Validation Constraints",
    description:
      "A generic event demonstrating various validation constraints and recursive documentation capabilities.",
    type: "object",
    ...
    properties: {
      $schema: {
        type: "string",
        const:
          "https://tracking-docs-demo.buchert.digital/schemas/events/complex-event.json",
      },
      event: {
        type: "string",
        const: "user_update",
