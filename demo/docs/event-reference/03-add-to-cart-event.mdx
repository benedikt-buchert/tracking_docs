...
<SchemaViewer
  schema={{
    ...
    $id: "https://tracking-docs-demo.buchert.digital/schemas/events/add-to-cart-event.json",
    title: "Add to Cart Event",
    description:
      "An add_to_cart event fires when a user adds one or more items to their shopping cart. Based on Google Analytics 4 ecommerce event specifications.",
    type: "object",
    ...
    properties: {
      $schema: {
        const:
          "https://tracking-docs-demo.buchert.digital/schemas/events/add-to-cart-event.json",
        type: "string",
      },
      event: {
        type: "string",
